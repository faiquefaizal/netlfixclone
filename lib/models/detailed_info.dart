...
class DetailedInfo {
  ...
  factory DetailedInfo.fromRawJson(String str) =>
      DetailedInfo.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailedInfo.fromJson(Map<String, dynamic> json) => DetailedInfo(
        adult: json["adult"],
